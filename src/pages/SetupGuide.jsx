...
export default function SetupGuide() {
  ...
  const targetHost = selectedServer?.ip_address || selectedServer?.tailscale_ip || (selectedServer?.prometheus_instance ? selectedServer.prometheus_instance.split(':')[0] : '100.84.0.9');
